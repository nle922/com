...
local var_to_fix = "e003tc" //put name of variable to fix here
local year = "1935" //put year this applies to here
local vars_in_formula = "e003tc12" //put set of variables used in formula for replacing here
...
if `continue_generating'{
	...
	gen `var_to_fix'_num = e003tc12 //put the formula for calculating the imputed variable here
