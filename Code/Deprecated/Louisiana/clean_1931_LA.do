...
*NLZ: Program to create and clean the 1931 LA data, 9/1/14
...
import excel ".\Original Data\1931_generalForm_LA_All.xlsx", sheet("Sheet1") cellrange(A4:W1051) firstrow allstring clear
...
//these are just temporary plant numbers
gen plant_id = _n
...
save "./Stata Data/LA_1931", replace
