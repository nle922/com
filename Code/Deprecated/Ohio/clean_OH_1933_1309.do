*NLZ: Program to create and clean the 1933 OH data for industry 1309, 11/9/10
...
log using OH_dataset_1933_1309.txt, text replace
set mem 200m

insheet using ".\Original Data\1933_Foundries\FinaL_Ohio_1933_Industry_1309.csv", comma
...
save "./Stata Data/OH_1933_1309", replace
log close
