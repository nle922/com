*NLZ: Program to create and clean the 1933 OH data for industry 1319
//the original data here was not very readable so this is provisional code.
...
log using OH_dataset_1933_1319.txt, text replace
set mem 200m

insheet using ".\Original Data\1933_Foundries\FinaL_Ohio_1933_Industry_1319.csv", comma
...
//there are more that need to be fixed by hand
destring  numdaysplantinoperation, force replace ignore("(Approximately) ")
...
capture tostring `i', replace force
...
destring wagespaid, replace force
...
destring quantity, replace force ignore("Tons Nt")
...
destring v55, replace force ignore("Tons Lb")
rename v55 output_quantity_3
destring v56, replace force ignore("?")
...
destring totalvalue, replace force
...
destring v71, replace force ignore(" ")
...
save "./Stata Data/OH_1933_1319", replace
log close
