...
replace `owner_name' = `establishment_name_virtual' if `establishment_name_virtual'=="DAVID GIVOTOFF" & `owner_name'==""
replace `owner_name' = `establishment_name_virtual' if `establishment_name_virtual'=="SERAPHIN ALEXANDER" & `owner_name'==""
replace `owner_name' = `establishment_name_virtual' if `establishment_name_virtual'=="(VIRGINIA BRANCH) THE AMERICAN TOBACCO COMPANY" & `owner_name'==""
replace `owner_name' = `establishment_name_virtual' if `establishment_name_virtual'=="R.J. REYNOLDS TOBACCO COMPANY" & `owner_name'==""
replace `owner_name' = `establishment_name_virtual' if `establishment_name_virtual'=="BENSON AND HEDGES" & `owner_name'==""
